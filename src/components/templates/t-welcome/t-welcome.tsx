    ...
    return (
        <main className={styles.t_welcome} id="t-welcome">
            ...
            <A_Text data-testid="a-text-description" variant="fwReg-fs20-lh30-gray500" id="a-text-description">
                Queremos que você se sinta em casa e aproveite ao máximo tudo o que oferecemos. Se tiver alguma dúvida
                ou precisar de ajuda, não hesite em nos chamar. Estamos sempre prontos para tornar sua experiência
                conosco incrível. Mais uma vez, bem-vindo(a)!
            </A_Text>
